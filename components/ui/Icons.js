...
export const ExitFullscreenIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 9V4H4m0 0l5 5M9 15v5H4m0 0l5-5m6-6V4h5m0 0l-5 5m5 6v5h-5m0 0l5-5" />
  </svg>
);
...
export const SkiIcon = ({ className = 'w-6 h-6' }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M18.5 4.5c1.1 0 2-.9 2-2s-.9-2-2-2-2 .9-2 2 .9 2 2 2zm-3 8.5L12 9.5 9.5 12 5 7.5 3.5 9l6 6-2.5 2.5L2 22l1.5 1.5 6.5-5 2.5 2.5 6-6-1.5-1.5-4.5 4.5 2.5-2.5-4.5-4.5 3.5-3.5 3 3.5z"/>
  </svg>
);
